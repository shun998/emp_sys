...
function checkFrom(){
	...
	var depart_name= document.editForm.depart_name.value;
	var depart_remark=document.editForm.depart_remark.value;
	var isName = 1;
	var isRemark = 1;
...
function show(){
	...
	if(document.editForm.depart_name.value!=""){
		document.getElementById("text").style.visibility = "hidden";
	}else{
		document.getElementById("text").style.visibility = "visible";
	}
	if(document.editForm.depart_remark.value!=""){
...
<DIV>
  ...
  height=47>
    ...
    vAlign=top align=middle>
          ...
          %>
          <form name="editForm" method="post"  action="<%=request.getContextPath()%>/hrManage/depart.do?method=edit" onsubmit="return checkFrom()" >
         <input type="hidden" name="depart_id" value="<%=map.get("depart_id")%>"/>
      ...
      border=1>
            ...
            src="<%=request.getContextPath()%>/images/employee/bg_users.gif"></TD>
                  ...
                  <TD class=gridViewItem><input type="text" name="depart_name" onblur="show()" size="37" value="<%=map.get("depart_name")%>"/>
                  <span id="text" style="color:red;visibility:hidden" width="50">*部门名称不能为空</span>
                  </TD>
                 </TR>
                  <TR>
                  <TD class=gridViewItem style="WIDTH: 50px"><IMG 
            src="<%=request.getContextPath()%>/images/employee/bg_users.gif"></TD>
                  ...
                  <TD class=gridViewItem><textarea name="depart_remark" rows="5" cols="30" onblur="show()"><%=map.get("depart_remark") %></textarea>
